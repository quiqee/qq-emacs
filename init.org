...
#+NAME: gen-use-pkg
#+BEGIN_SRC emacs-lisp :var package="example" :var after="" :var straight="" :var strght_gh="" :var demand="" :var defer="" :var hook="" :var init="" :var firsttag="config" :results output :tangle no :exports none
...
;; Compile on save (optional, disabled by default)
;; (setq typst-ts-mode-compile-on-save t)
#+END_SRC
