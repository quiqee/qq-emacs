...
- **[[*Claude Code][claude-code]]**: Emacs interface for Claude Code CLI with terminal integration and error fixing
...
| Key | Command                        | Description                     |
|-----+--------------------------------+---------------------------------|
| a a | claude-code-transient          | Open Claude transient menu      |
| a c | claude-code                    | Start Claude Code               |
| a s | claude-code-send               | Send command to Claude          |
| a r | claude-code-send-region        | Send region to Claude           |
| a . | claude-code-fix-error-at-point | Fix error at point with Claude  |
| a t | claude-code-toggle             | Toggle Claude window visibility |
| a / | claude-code-slash-commands     | Send slash command to Claude    |
...
** Claude Code
Emacs interface for Claude Code CLI with terminal integration and error fixing capabilities. → [[*Claude Code Package][Generated Code]]
...
#+BEGIN_SRC emacs-lisp :tangle no :exports none
  ...
  ;; Optional: Customize newline behavior
  ;; (setq claude-code-newline-style 'shift-return-to-send)
...
#+BEGIN_SRC emacs-lisp :noweb yes :exports none :results silent
<<gen-use-pkg(package="inheritenv", strght_gh="purcell/inheritenv")>>
<<gen-pkg-end()>>
<<gen-use-pkg(package="monet", strght_gh="stevemolitor/monet")>>
<<gen-pkg-end()>>
<<gen-use-pkg(package="claude-code", strght_gh="stevemolitor/claude-code.el")>>
<<claude-code-config>>
<<claude-code-custom>>
<<gen-pkg-end()>>
#+END_SRC
