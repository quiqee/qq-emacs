...
- **[[*Bitbake Modes][bitbake-modes]]**: Yocto/OpenEmbedded BitBake recipe editing
...
***** Bitbake Modes
Yocto/OpenEmbedded BitBake recipe editing with support for .bb, .bbappend, .bbclass, and .inc files. → [[*Bitbake Modes Package][Generated Code]]

****** Bitbake Modes Configuration Block
#+NAME: bitbake-modes-config
#+BEGIN_SRC emacs-lisp :tangle no :exports none
;; BitBake modes are automatically loaded for .bb, .bbappend, .bbclass files
...
*** Bitbake Modes Package
Yocto/OpenEmbedded BitBake recipe editing with support for .bb, .bbappend, .bbclass files. → [[*Bitbake Modes][Configuration]]
#+BEGIN_SRC emacs-lisp :noweb yes :exports none :results silent
<<gen-use-pkg(package="bitbake-modes")>>
<<bitbake-modes-config>>
<<gen-pkg-end()>>
#+END_SRC
