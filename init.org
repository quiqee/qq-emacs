...
#+NAME: gen-use-pkg
#+BEGIN_SRC emacs-lisp :var package="example" :var after="" :var straight="" :var strght_gh="" :var demand="" :var defer="" :var hook="" :var mode="" :var init="" :var firsttag="config" :results output :tangle no :exports none
(let ((header (format "(use-package %s" package))
      ...
      (config-line (format "\n  :%s" firsttag)))
  (princ (concat header straight-line after-line demand-line defer-line hook-line mode-line init-line config-line)))
#+END_SRC
