   ...
   #+BEGIN_SRC emacs-lisp :tangle ~/.emacs.d/bin/packages.el
     ...
     (mapcar (lambda (package)
             ...
             '(
               ...
               dash-doc                      ; Offline documentation browser using Dash docsets.
               calibredb
               mode-line-bell
               helpful
...
** Keybindings
   ...
   #+TBLNAME: std_keys
      ...
      | C-C d   | Dash Docs search or at point                                      | 'qq/dash-search              |
   ...
   #+begin_src emacs-lisp
     ...
     (defun qq/region-symbol-query()
       ...
       (let* ((w (if (or  (not current-prefix-arg) (not (listp current-prefix-arg)))
         ...
         result))
     (defun qq/dash-search(&optional w)
       (interactive)
       (dash-docs-search (if w w (qq/region-symbol-query))))
   #+end_src
