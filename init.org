...
*** Android development
   #+BEGIN_SRC emacs-lisp
     (defun android-cedet-setup ()
       ...
       (setq mtk-root "prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.8")
       ...
       (semantic-add-system-include (concat pq-backend-location "/PQControl/include")   'cc-mode)

       (add-to-list 'semantic-lex-c-preprocessor-symbol-file
                    (concat mtk-root "/lib/gcc/arm-linux-androideabi/4.8/include/stddef.h"))
