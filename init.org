...
;; Configure sourcekit-lsp path for Swift LSP
(with-eval-after-load 'lsp-mode
...
(defun qq/kmp-ios-build () (interactive) (qq/kmp-gradle "iosApp:compileKotlinIosSimulatorArm64"))
(defun qq/kmp-ios-arm () (interactive) (qq/kmp-gradle "iosApp:compileKotlinIosArm64"))
...
(with-eval-after-load 'transient
  (transient-define-prefix qq/kmp-menu ()
    ...
    ["Android"
     ...
     ("r" "Assemble Release" qq/kmp-android-release)]
    ["iOS"
