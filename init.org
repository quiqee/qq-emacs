...
** CEDET
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     ;                       (concat user-emacs-directory "extern/cedet/")))

     ;(load-file (concat cedet-root-path "cedet-devel-load.el"))
     ;(load-file (concat cedet-root-path "contrib/cedet-contrib-load.el"))
     ;(add-to-list 'Info-directory-list (concat user-emacs-directory "extern/cedet/doc/info"))
   #+END_SRC
...
*** Semantic
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     ;    "/home/fikri/toolchains/ppc405_gcc482/lib/gcc/powerpc-greenwave-linux-gnu/4.8.2/include/stddef.h")
   #+END_SRC
...
*** Project related settings
   #+BEGIN_SRC emacs-lisp
     ...
     ;(when (file-exists-p "/lego/master/lego.env")
     ;   (setq lego-project
     ;       (ede-cpp-root-project "lego-master"
     ;                   :file "/lego/master/README"
     ;                   :system-include-path '("/lego/master/output/onegw/thirdparty-include"
     ;                               "/lego/master/output/onegw/boost_1_54_0")
     ;                   :compile-command "source lego.env && cd products/onegw && set_lego_product && VERBOSE=1 make firmware_bays"
     ;                   )))
   ...
   #+BEGIN_SRC emacs-lisp
     (when (require 'auto-complete-config nil 'noerror) ;; don't break if not installed
       (add-to-list 'ac-dictionary-directories
              (concat qq/cache-directory "ac-dict"))
       (setq ac-comphist-file
              (concat qq/cache-directory "ac-comphist.dat"))
       (ac-config-default))
   #+END_SRC
