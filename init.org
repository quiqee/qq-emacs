...
(defun qq/kmp-ios-log ()
  (interactive)
  (async-shell-command "xcrun simctl spawn booted log stream --level debug --predicate 'subsystem contains \"com.rahl\" OR message contains \"Kermit\"'" "*ios-log*"))
...
(with-eval-after-load 'transient
  (transient-define-prefix qq/kmp-menu ()
    ...
    ["Android"
     ...
     ("A" "Assemble Debug" qq/kmp-android-assemble)
     ("e" "Assemble Release" qq/kmp-android-release)
