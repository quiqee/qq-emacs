...
;; Disable ligatures in agent-shell buffers to prevent PragmataPro
;; from replacing markdown headings (##) with SF Symbol glyphs
(add-hook 'agent-shell-mode-hook (lambda ()
                                   (ligature-mode -1)
