...
#+PROPERTY: header-args :tangle "~/.emacs.d/init.el" :tangle yes :comments org
...
** Dot Emacs
   Most of the settings below are copied from all over the web. Some notable
   dot-emacs that I copied most are from:
