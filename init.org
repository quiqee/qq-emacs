...
** CEDET
   ...
   #+BEGIN_SRC emacs-lisp
     (setq AndroidRoot (concat (expand-file-name "~") "/fb5"))
     (setq TPVision (concat AndroidRoot "/device/tpvision"))
     (setq PQBackendLocation (concat TPVision "/tvsoc/backend/comps"))
     ...
     (semantic-add-system-include (concat TPVision "/common/plf/tpapi/inc")	'cc-mode)
     (semantic-add-system-include (concat TPVision "/tvsoc/tvsoc_mtk/src/private_inc")	'cc-mode)
     (semantic-add-system-include (concat PQBackendLocation "/PQControl/include")	'cc-mode)
     ...
     (add-hook 'c-mode-common-hook 'qq/cedet-hook)
     (add-hook 'lisp-mode-hook 'qq/cedet-hook)
     (add-hook 'scheme-mode-hook 'qq/cedet-hook)
     (add-hook 'emacs-lisp-mode-hook 'qq/cedet-hook)
     (add-hook 'erlang-mode-hook 'qq/cedet-hook)

     (defun qq/c-mode-cedet-hook ()
       (local-set-key "\C-ct" 'eassist-switch-h-cpp)
       (local-set-key "\C-xt" 'eassist-switch-h-cpp)
       (local-set-key "\C-ce" 'eassist-list-methods)
       (local-set-key "\C-c\C-r" 'semantic-symref)
       )
     (add-hook 'c-mode-common-hook 'qq/c-mode-cedet-hook)
